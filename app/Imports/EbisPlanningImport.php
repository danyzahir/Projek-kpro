...
class EbisPlanningImport implements ToModel, WithHeadingRow
{
    ...
    public function model(array $row)
    {
        return new EbisPlanningOrder([
            ...
            'nama_pengguna_melakukan_alokasi_alpro' => $row['nama_pengguna_melakukan_alokasi_alpro'] ?? null,
            'username_nik_alokasi_alpro' => $row['username_nik_alokasi_alpro'] ?? null,
            ...
            'status_tomps_last_update' => $row['status_tomps_last_update'] ?? null,
            'status_sap' => $row['status_sap'] ?? null,
            'status_proyek' => $row['status_proyek'] ?? null,

            // ===== DATE LANJUTAN =====
            'odp_go_live' => $this->cleanDate($row['odp_go_live'] ?? null),
            'tanggal_waiting_caring' => $this->cleanDate($row['tanggal_waiting_caring'] ?? null),
            'tanggal_submitted_to_eproposal' => $this->cleanDate($row['tanggal_submitted_to_eproposal'] ?? null),
            'tanggal_inisiasi_tomps' => $this->cleanDate($row['tanggal_inisiasi_tomps'] ?? null),
            'tanggal_validasi_abd_tomps' => $this->cleanDate($row['tanggal_validasi_abd_tomps'] ?? null),
            'tanggal_go_live_tomps' => $this->cleanDate($row['tanggal_go_live_tomps'] ?? null),
