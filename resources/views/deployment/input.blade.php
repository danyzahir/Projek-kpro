    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            ...
            <form x-data="ebisForm()" x-init="formEl = $el" method="POST" action="{{ route('ebis.manual.store') }}"
                class="space-y-8" @input="checkRequired()" @change="checkRequired()">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div data-field-wrapper>
                        ...
                        <select name="nama_mitra" data-required="true"
                            class="w-full rounded-lg border px-3 py-2 text-sm
                             focus:ring-2 focus:ring-red-500 focus:outline-none">
                            <option value="">-- Pilih Nama Mitra --</option>
                            <option>PT UPAYA TEKNIK</option>
                            <option>PT SARANA MITRA PERSADA</option>
                            <option>PT LINEA</option>
                            <option>PT TRIPOLA</option>
                        </select>
