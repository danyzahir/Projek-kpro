...
<div class="max-w-7xl mx-auto space-y-8">
    ...
    <div class="flex items-center gap-3 text-sm text-slate-500">
        ...
        <span>›</span>
        <span class="font-semibold text-slate-800">OLO</span>
    </div>
           ...
           class="group relative overflow-hidden rounded-3xl p-8 h-64
            ...
            <div class="z-10">
                ...
                <p class="text-red-100 mt-1 text-sm font-medium opacity-90">
                    Tambah data OLO deployment baru
                </p>
            </div>
           ...
           class="group relative overflow-hidden rounded-3xl p-8 h-64
            ...
            <div class="z-10">
                ...
                <p class="text-slate-500 mt-1 text-sm">
                    Perbarui status progress OLO deployment
                </p>
            </div>
        </a>
        ...
        <a href="{{ route('deployment.lihat-data') }}" 
           class="group relative overflow-hidden rounded-3xl p-8 h-64
            ...
            <div class="z-10">
                ...
                <p class="text-slate-500 mt-1 text-sm">
                    Monitoring dan rekap data OLO deployment
                </p>
            </div>
        </a>
        ...
        <a href="{{ route('deployment.upload') }}"
           class="group relative overflow-hidden rounded-3xl p-8 h-64
            ...
            <div class="z-10">
                ...
                <p class="text-slate-500 mt-1 text-sm">
                    Import data OLO massal via file excel
                </p>
            </div>
        </a>
